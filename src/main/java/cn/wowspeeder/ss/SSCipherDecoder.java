...
public class SSCipherDecoder extends MessageToMessageDecoder<Object> {
    private static Logger logger = LoggerFactory.getLogger(SSCipherDecoder.class);


    @Override
    protected void decode(ChannelHandlerContext ctx, Object msg, List<Object> list) throws Exception {
